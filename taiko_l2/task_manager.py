...
class TaskManager:
    ...
    def run_one_block(self, block_id: int):
        ...
        self.scanner.parse_token_vault_l2_event_erc20_sent()
        self.scanner.parse_token_vault_l2_event_erc20_received()
        ...
        self.scanner.save_token_vault_l2_event_erc20_sent()
        self.scanner.save_token_vault_l2_event_erc20_received()
